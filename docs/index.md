...
Welcome to the documentation for **Hybrid_Lib_Ada**, a canonical Ada 2022 library demonstrating hexagonal architecture (DDD/Clean/Hex) with:
...
Hybrid_Lib_Ada follows a **4-layer library architecture**:
...
│  - Hybrid_Lib_Ada.API.Desktop (composition root)        │
│  - Hybrid_Lib_Ada.API.Operations (SPARK-safe)           │
└─────────────────────────┬───────────────────────────────┘
                          │
┌─────────────────────────┼───────────────────────────────┐

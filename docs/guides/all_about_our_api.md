...
The examples below use `Hybrid_Lib_Ada` with a simplified "Greet" use case to illustrate the architectural concepts clearly. The same patterns apply to any project using this architecture - only the domain-specific types and operations differ.
